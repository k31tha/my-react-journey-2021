...
test('renders 2nd basic club details', () => {
    const {container} = render( <ClubDetails clubId={1} clubName={"Knaphill"} clubLogo={null}  clubAddress={"dummy street, dummy town, DD333MY"}/>);
  ...
  test('renders 3rd basic club details', () => {
    render( <ClubDetails clubId={1} clubName={"Knaphill"} clubLogo={null}  clubAddress={"dummy street, dummy town, DD333MY"}/>);
    screen.debug();
